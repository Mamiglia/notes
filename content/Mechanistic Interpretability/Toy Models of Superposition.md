...
e.g. curve detectors are reliably found in each and every vision model, sentiment detectors are found in any LLM, and inductixon heads are in any sequence model (this kinda reminds me of platonic representation conjecture).
